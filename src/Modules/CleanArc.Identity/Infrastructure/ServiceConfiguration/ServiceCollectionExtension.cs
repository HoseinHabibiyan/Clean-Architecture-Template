...
using CleanArc.Identity.Infrastructure.Identity;
...
using CleanArc.Identity.Infrastructure.Identity.PermissionManager;
using CleanArc.Identity.Infrastructure.Identity.SeedDatabaseService;
using CleanArc.Identity.Infrastructure.Identity.Store;
using CleanArc.Identity.Infrastructure.Identity.validator;
...
namespace CleanArc.Identity.Infrastructure.ServiceConfiguration;
...
public static class ServiceCollectionExtension
{
	public static IServiceCollection RegisterIdentityServices(this IServiceCollection services, IdentitySettings identitySettings)
	{
		...
		services.AddScoped<IUserStore<Domain.User>, AppUserStore>();
